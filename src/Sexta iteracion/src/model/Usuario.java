...
public class Usuario {
	...
	public void suscribirseAServicioDeNotificaciones(ServicioDeNotificaciones servicio) {
		servicio.suscribirUsuario(this);
	}

	public void desuscribirseAServicioDeNotificaciones(ServicioDeNotificaciones servicio) {
